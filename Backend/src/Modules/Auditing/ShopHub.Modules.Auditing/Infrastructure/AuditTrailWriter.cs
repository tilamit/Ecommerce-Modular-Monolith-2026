...
/// and one round trip per entry would make auditing the dominant database cost. A write
/// failure is logged and the batch dropped, per the spec's "log it, drop it, alert" - the
/// alternative is retrying behind a queue that fills, turning a logging problem into an
/// outage.
/// </remarks>
