...
public sealed class CatalogModule : IModule
{
    ...
    public IServiceCollection RegisterModule(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.Configure<Features.Products.ProductImageOptions>(
            configuration.GetSection(Features.Products.ProductImageOptions.SectionName));

        services.AddSingleton<Features.Products.ProductImageStorage>();
