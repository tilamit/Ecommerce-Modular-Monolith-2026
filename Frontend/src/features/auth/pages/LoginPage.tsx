...
export const LoginPage = () => {
  ...
  const onSubmit = form.handleSubmit(async (values) => {
    ...
    // Signed in from here on. /me only fills in the profile and the menu, so its failure is
    // not a failed sign-in: reporting one would leave the user holding a live session under
    // an error telling them they have none. The sidebar loads the menu itself if this missed.
