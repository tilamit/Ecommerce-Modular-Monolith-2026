...
export const RegisterPage = () => {
  ...
  const onSubmit = form.handleSubmit(async (values) => {
    ...
    // The account exists and the session is live. Failing here on /me would say "could not
    // create your account" and trying again would then answer "email already exists".
