...
/// </para>
/// <para>
/// Append-only means exactly that - there is no mutator on this type, no update endpoint,
/// and no admin override. A trail an administrator can edit is not evidence of anything.
/// </para>
/// </remarks>
