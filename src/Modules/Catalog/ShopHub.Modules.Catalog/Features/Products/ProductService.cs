    ...
    IClock clock)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (!useCache)
        {
            return await QueryProductsAsync(request, filter, cancellationToken);
        }
        ...
        return await cache.GetOrCreateAsync(
            ...
            static async (state, ct) => await state.Service.QueryProductsAsync(state.Request, state.Filter, ct),
            ListCacheOptions,
